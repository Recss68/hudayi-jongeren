...
<footer class="footer">
	<div class="inner">
		...
		<nav class="navigation">
			...
			<ul class="list">
				...
				<li>
					<a class="link" href="/activiteiten"
						>{m.footer_activities({}, { locale: activeLocale })}</a
					>
				</li>
				<li>
		...
		<section class="contact">
			...
			<address class="address">
				...
				<span class="contact-row">
					<img src={mailIcon} alt="" class="icon" />
					<a class="link" href="mailto:info@hudayigenclik.nl"> info@hudayigenclik.nl </a>
				</span>
			</address>
	...
	<div class="bottom">
		...
		<a class="donation-link" href="/doneren"
			>{m.footer_donation_cta({}, { locale: activeLocale })}</a
		>
	</div>
</footer>
...
<style>
	.footer {
		color: var(--c-creme, var(--c-creme-hex));
	}
	...
	.social-link {
		...
		height: 2.5rem;
		border-radius: 999px;
		background-color: rgb(247 225 199 / 0.1);
		color: var(--c-creme, var(--c-creme-hex));
		text-decoration: none;
	}
	...
	.bottom {
		...
		border-top: 1px solid rgb(244 235 204 / 0.65);
	}
	...
	@media (min-width: 768px) {
		.inner {
			...
			margin: 0 auto;
			padding: 4.5rem var(--container-pad) 3.5rem;
		}
		...
		@media (min-width: 1024px) {
			...
			.social-link:hover,
			.social-link:focus-visible {
				background-color: rgb(247 225 199 / 0.18);
			...
			.donation-link:hover,
			.donation-link:focus-visible {
				background-color: var(--c-creme, var(--c-creme-hex));
				color: var(--c-nachtgroen, var(--c-nachtgroen-hex));
			}
		}
	}
</style>
