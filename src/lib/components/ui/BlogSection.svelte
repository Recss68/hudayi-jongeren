<script>
	...
	function getArticleContent(article) {
		return (
			article?.translations?.[activeLocale] ??
...
<section class="section blog-section">
	<div class="section-inner">
		<div class="section-header">
			...
			<a href={resolve('/haberler')} class="header-link"
				>{m.blog_view_all({}, { locale: activeLocale })}</a
			>
		</div>
				...
				{#each articles as article (article.id)}
					<li class="article-card">
						...
						<div class="card-content">
							...
							<a href={resolve(`/haberler/${article.slug}`)} class="card-link"
								>{m.blog_read_more({}, { locale: activeLocale })} →</a
							>
						</div>
					</li>
				{/each}
